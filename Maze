...
namespace ConsoleApplication13
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //WARNING!
            //Keep in mind that the obstacles are put in such a way so that the entrance and
            //the exit must not be blocked. 
            //In such a case you have to run the console again.
            ...
            Console.WriteLine("Congratsulations! The hero has reached his goal!");
        }
    }
}
